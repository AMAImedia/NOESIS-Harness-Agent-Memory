...
This is the primary English entry point for the 2026-08-17 release-readiness audit. The local private release candidate is evaluated only against reproducible local gates: stdlib-only policy, test regression, AST safety, evidence integrity, documentation links, and remote consistency.
