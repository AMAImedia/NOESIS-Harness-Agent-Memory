...
**Evidence SHA-256:** `1a92645ed97c36f3379847c933221ff639f1c6810ce5947603f289f0c5f486f2`
...
| `markdown-links` | Local relative links без network; generated `runtime/` docs исключены из project scope | `passed`; 65 Markdown files, 26 local links, missing `0` |
