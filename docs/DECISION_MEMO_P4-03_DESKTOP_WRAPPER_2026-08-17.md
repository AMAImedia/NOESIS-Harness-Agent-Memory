...
No desktop wrapper is represented as native-ready solely because a source artifact or launcher exists. The detailed Russian decision memo is available in [`DECISION_MEMO_P4-03_DESKTOP_WRAPPER_2026-08-17_RU.md`](DECISION_MEMO_P4-03_DESKTOP_WRAPPER_2026-08-17_RU.md).
