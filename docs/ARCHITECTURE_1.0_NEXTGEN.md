...
| Workload benchmark | `MultiAgentWorkloadRunner`, `DurableWorkloadAggregator` | Multiple parallel deterministic lanes, injected first-attempt crash, bounded retry, SQLite/WAL result aggregation, duplicate replay and content-conflict rejection |
