...
This is the normative English entry point for the NOESIS 1.0 implementation plan. The project advances through evidence-backed gates covering the Trust Plane, durable sessions, memory, multi-agent governance, child execution, portable UI, native packaging, and external benchmarking.
