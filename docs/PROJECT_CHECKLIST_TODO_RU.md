...
| P5-01 | Hermes/DeepSeek integration tests | Агент | `DONE / LOCAL VERIFIED` | Local stdlib gateway fixtures for Hermes/DeepSeek; auth and readiness probes; audit JSONL without credential/payload leakage; per-agent audit identity; 4/4 focused tests; commit/remote verification pending |
