...
Последний подтверждённый remote commit: `4046605` — `feat: isolate cross-platform user data paths`

Текущий рабочий этап: **P1-03 user-data separation remote verified; следующий gate — P1-04 auth и LAN warning**
