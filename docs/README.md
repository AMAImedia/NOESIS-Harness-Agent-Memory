...
| [`GATE3_RECEIPT_STORE_AUDIT.md`](GATE3_RECEIPT_STORE_AUDIT.md) | Deterministic audit of every stored execution receipt with digest/HMAC/identity verification and fail-closed corruption handling; Russian localization: [`GATE3_RECEIPT_STORE_AUDIT_RU.md`](locales/ru/GATE3_RECEIPT_STORE_AUDIT_RU.md). |
| [`GATE3_RECEIPT_LIFECYCLE.md`](GATE3_RECEIPT_LIFECYCLE.md) | Immutable prepared-to-terminal-to-rollback receipt transitions with request/policy/workspace/artifact binding; Russian localization: [`GATE3_RECEIPT_LIFECYCLE_RU.md`](locales/ru/GATE3_RECEIPT_LIFECYCLE_RU.md). |
| [`GATE3_RECEIPT_CHAIN.md`](GATE3_RECEIPT_CHAIN.md) | Ordered immutable receipt-chain verification with gap, reorder, fork, duplicate and tamper rejection; Russian localization: [`GATE3_RECEIPT_CHAIN_RU.md`](locales/ru/GATE3_RECEIPT_CHAIN_RU.md). |
| [`GATE3_DURABLE_RECEIPT_CHAIN.md`](GATE3_DURABLE_RECEIPT_CHAIN.md) | Reopen-verified ordered receipt chains loaded from SQLite/WAL with missing-entry, reorder and stored-tamper rejection; Russian localization: [`GATE3_DURABLE_RECEIPT_CHAIN_RU.md`](locales/ru/GATE3_DURABLE_RECEIPT_CHAIN_RU.md). |
| [`GATE3_CHAIN_SNAPSHOTS.md`](GATE3_CHAIN_SNAPSHOTS.md) | Persistent idempotent chain snapshots with deterministic IDs, reopen verification, snapshot tamper detection and current-chain drift rejection; Russian localization: [`GATE3_CHAIN_SNAPSHOTS_RU.md`](locales/ru/GATE3_CHAIN_SNAPSHOTS_RU.md). |
| [`GATE3_SNAPSHOT_RECOVERY_LINK.md`](GATE3_SNAPSHOT_RECOVERY_LINK.md) | Recovery actions bound to persisted receipt-chain snapshots with target membership, replay fingerprinting and completion receipt linkage; Russian localization: [`GATE3_SNAPSHOT_RECOVERY_LINK_RU.md`](locales/ru/GATE3_SNAPSHOT_RECOVERY_LINK_RU.md). |
| [`GATE3_RECOVERY_COMPLETION_RECEIPTS.md`](GATE3_RECOVERY_COMPLETION_RECEIPTS.md) | Signed committed completion receipts linked from append-only recovery events with replay-time receipt verification; Russian localization: [`GATE3_RECOVERY_COMPLETION_RECEIPTS_RU.md`](locales/ru/GATE3_RECOVERY_COMPLETION_RECEIPTS_RU.md). |
| [`GATE3_RECOVERY_EVENT_CHAIN.md`](GATE3_RECOVERY_EVENT_CHAIN.md) | Hash-linked append-only completion-event audit with receipt references and reorder, fork, corruption, and replay rejection; Russian localization: [`GATE3_RECOVERY_EVENT_CHAIN_RU.md`](locales/ru/GATE3_RECOVERY_EVENT_CHAIN_RU.md). |
| [`GATE3_EVENT_CHAIN_SNAPSHOTS.md`](GATE3_EVENT_CHAIN_SNAPSHOTS.md) | Signed atomic sidecar snapshots of recovery completion-event chains with reopen verification, HMAC validation and event-log drift rejection; Russian localization: [`GATE3_EVENT_CHAIN_SNAPSHOTS_RU.md`](locales/ru/GATE3_EVENT_CHAIN_SNAPSHOTS_RU.md). |
| [`GATE3_RECOVERY_EVIDENCE_STARTUP.md`](GATE3_RECOVERY_EVIDENCE_STARTUP.md) | Explicit startup/replay verification gate requiring a valid snapshot for non-empty recovery event chains and preserving empty-log `not_run` honesty; Russian localization: [`GATE3_RECOVERY_EVIDENCE_STARTUP_RU.md`](locales/ru/GATE3_RECOVERY_EVIDENCE_STARTUP_RU.md). |
| [`GATE3_RECOVERY_EVIDENCE_STATUS.md`](GATE3_RECOVERY_EVIDENCE_STATUS.md) | Machine-readable `passed`/`not_run`/`blocked` projection with an explicit claim flag and deterministic rejection reasons; Russian localization: [`GATE3_RECOVERY_EVIDENCE_STATUS_RU.md`](locales/ru/GATE3_RECOVERY_EVIDENCE_STATUS_RU.md). |
| [`GATE3_RECOVERY_STATUS_SNAPSHOTS.md`](GATE3_RECOVERY_STATUS_SNAPSHOTS.md) | Signed persistent status projections with atomic replacement, HMAC verification and underlying-evidence drift rejection; Russian localization: [`GATE3_RECOVERY_STATUS_SNAPSHOTS_RU.md`](locales/ru/GATE3_RECOVERY_STATUS_SNAPSHOTS_RU.md). |
| [`GATE3_STATUS_SNAPSHOT_REPLAY.md`](GATE3_STATUS_SNAPSHOT_REPLAY.md) | Exact recovery replay requires a valid signed status snapshot in addition to action fingerprint and committed completion receipt; Russian localization: [`GATE3_STATUS_SNAPSHOT_REPLAY_RU.md`](locales/ru/GATE3_STATUS_SNAPSHOT_REPLAY_RU.md). |
| [`GATE3_REPLAY_OUTCOME_EVIDENCE.md`](GATE3_REPLAY_OUTCOME_EVIDENCE.md) | Read-only `noesis.recovery-replay-evidence.v1` projection binds action, committed receipt and verified status snapshot; Russian localization: [`GATE3_REPLAY_OUTCOME_EVIDENCE_RU.md`](locales/ru/GATE3_REPLAY_OUTCOME_EVIDENCE_RU.md). |
