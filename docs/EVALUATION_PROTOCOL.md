...
The detailed Russian localization is available in [`EVALUATION_PROTOCOL_RU.md`](locales/ru/EVALUATION_PROTOCOL_RU.md). The localized document explains the same contract and does not change schemas, commands, metrics, or acceptance gates.
