...
Текущие conformance tests покрывают bounded turns, lease-miss action suppression, loop-guard stop и judge-gated completion. External provider lanes остаются disabled, пока operator не предоставит pinned environments и signed receipts.
