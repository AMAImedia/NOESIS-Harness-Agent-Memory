...
**Evidence SHA-256:** `9670271eb713b0538886395651e03321f65d453ee9b75cf5b11bddc017ce79bd`
...
| `markdown-links` | Local relative links без network; generated `runtime/` docs исключены из project scope | `passed`; 77 Markdown files, 39 local links, missing `0` |
| `json-evidence` | JSON parseability и `schema_version` для selected evidence/manifests | `passed`; 17 files, findings `0` |
