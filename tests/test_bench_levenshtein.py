import unittest
import benchmarks.bench_levenshtein as bm

class TestBenchLevenshtein(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_levenshtein; self.assertTrue(hasattr(benchmarks.bench_levenshtein, "bench"))
