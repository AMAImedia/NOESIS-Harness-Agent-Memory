import unittest
import benchmarks.bench_ring_factory as bm

class TestBenchRingFactory(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_factory; self.assertTrue(hasattr(benchmarks.bench_ring_factory,"bench"))
