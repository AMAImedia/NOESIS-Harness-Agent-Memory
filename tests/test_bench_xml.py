import unittest
import benchmarks.bench_xml as bm

class TestBenchXml(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_xml; self.assertTrue(hasattr(benchmarks.bench_xml,"bench"))
