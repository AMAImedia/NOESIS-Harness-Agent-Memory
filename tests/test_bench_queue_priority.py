import unittest
import benchmarks.bench_queue_priority as bm

class TestBenchQueuePriority(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_priority; self.assertTrue(hasattr(benchmarks.bench_queue_priority,"bench"))
