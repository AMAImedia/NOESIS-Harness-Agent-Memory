import unittest
import benchmarks.bench_queue_parallel as bm

class TestBenchQueueParallel(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_parallel; self.assertTrue(hasattr(benchmarks.bench_queue_parallel,"bench"))
