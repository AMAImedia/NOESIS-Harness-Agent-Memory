import unittest
import benchmarks.bench_chunked_jsonl as bm

class TestBenchChunkedJsonl(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_chunked_jsonl; self.assertTrue(hasattr(benchmarks.bench_chunked_jsonl,"bench"))
