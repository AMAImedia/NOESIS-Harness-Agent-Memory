import unittest
import benchmarks.bench_slugify as bm

class TestBenchSlugify(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_slugify; self.assertTrue(hasattr(benchmarks.bench_slugify, "bench"))
