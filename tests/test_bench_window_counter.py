import unittest
import benchmarks.bench_window_counter as bm

class TestBenchWindowCounter(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_window_counter; self.assertTrue(hasattr(benchmarks.bench_window_counter,"bench"))
