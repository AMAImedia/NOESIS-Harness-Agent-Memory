import unittest
import benchmarks.bench_queue_dedup as bm

class TestBenchQueueDedup(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_dedup; self.assertTrue(hasattr(benchmarks.bench_queue_dedup,"bench"))
