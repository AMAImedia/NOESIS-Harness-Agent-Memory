import unittest
import benchmarks.bench_ring_parallel as bm

class TestBenchRingParallel(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_parallel; self.assertTrue(hasattr(benchmarks.bench_ring_parallel,"bench"))
