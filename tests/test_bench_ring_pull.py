import unittest
import benchmarks.bench_ring_pull as bm

class TestBenchRingPull(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_pull; self.assertTrue(hasattr(benchmarks.bench_ring_pull,"bench"))
