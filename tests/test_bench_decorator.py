import unittest
import benchmarks.bench_decorator as bm

class TestBenchDecorator(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_decorator; self.assertTrue(hasattr(benchmarks.bench_decorator,"bench"))
