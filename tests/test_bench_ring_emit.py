import unittest
import benchmarks.bench_ring_emit as bm

class TestBenchRingEmit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_emit; self.assertTrue(hasattr(benchmarks.bench_ring_emit,"bench"))
