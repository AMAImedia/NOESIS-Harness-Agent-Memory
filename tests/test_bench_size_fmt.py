import unittest
import benchmarks.bench_size_fmt as bm

class TestBenchSizeFmt(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_size_fmt; self.assertTrue(hasattr(benchmarks.bench_size_fmt, "bench"))
