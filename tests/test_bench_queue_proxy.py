import unittest
import benchmarks.bench_queue_proxy as bm

class TestBenchQueueProxy(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_proxy; self.assertTrue(hasattr(benchmarks.bench_queue_proxy,"bench"))
