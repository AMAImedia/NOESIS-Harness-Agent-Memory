import unittest
import benchmarks.bench_ring_exit as bm

class TestBenchRingExit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_exit; self.assertTrue(hasattr(benchmarks.bench_ring_exit,"bench"))
