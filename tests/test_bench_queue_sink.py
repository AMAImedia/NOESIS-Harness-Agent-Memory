import unittest
import benchmarks.bench_queue_sink as bm

class TestBenchQueueSink(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_sink; self.assertTrue(hasattr(benchmarks.bench_queue_sink,"bench"))
