import unittest
import benchmarks.bench_buffer_ring as bm

class TestBenchBufferRing(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_buffer_ring; self.assertTrue(hasattr(benchmarks.bench_buffer_ring,"bench"))
