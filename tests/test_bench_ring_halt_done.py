import unittest
import benchmarks.bench_ring_halt_done as bm

class TestBenchRingHaltDone(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_halt_done; self.assertTrue(hasattr(benchmarks.bench_ring_halt_done,"bench"))
