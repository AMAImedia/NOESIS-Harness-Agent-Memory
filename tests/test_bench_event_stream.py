import unittest
import benchmarks.bench_event_stream as bm

class TestBenchES(unittest.TestCase):
    def test_main_zero(self): self.assertEqual(bm.main(["--events", "10"]), 0)
    ...
    def test_count(self): self.assertEqual(bm.bench(7)["events"], 7)
    def test_lazy(self): import benchmarks.bench_event_stream; self.assertTrue(hasattr(benchmarks.bench_event_stream, "bench"))
