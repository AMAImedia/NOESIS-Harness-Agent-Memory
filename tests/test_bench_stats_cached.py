import unittest
import benchmarks.bench_stats_cached as bm

class TestBenchStatsCached(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_stats_cached; self.assertTrue(hasattr(benchmarks.bench_stats_cached,"bench"))
