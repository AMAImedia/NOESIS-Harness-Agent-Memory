import unittest
import benchmarks.bench_queue_flush as bm

class TestBenchQueueFlush(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_flush; self.assertTrue(hasattr(benchmarks.bench_queue_flush,"bench"))
