import unittest
import benchmarks.bench_ring_pipe as bm

class TestBenchRingPipe(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_pipe; self.assertTrue(hasattr(benchmarks.bench_ring_pipe,"bench"))
