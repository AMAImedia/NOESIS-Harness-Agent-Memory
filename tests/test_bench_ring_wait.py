import unittest
import benchmarks.bench_ring_wait as bm

class TestBenchRingWait(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_wait; self.assertTrue(hasattr(benchmarks.bench_ring_wait,"bench"))
