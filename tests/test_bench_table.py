import unittest
import benchmarks.bench_table as bm

class TestBenchTable(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_table; self.assertTrue(hasattr(benchmarks.bench_table, "bench"))
