import unittest
import benchmarks.bench_counter as bm

class TestBenchCounter(unittest.TestCase):
    ...
    def test_count(self): self.assertEqual(bm.bench(7)["ops"], 7)
    def test_lazy(self): import benchmarks.bench_counter; self.assertTrue(hasattr(benchmarks.bench_counter, "bench"))
