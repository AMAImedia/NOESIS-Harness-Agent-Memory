import unittest
import benchmarks.bench_ring_node as bm

class TestBenchRingNode(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_node; self.assertTrue(hasattr(benchmarks.bench_ring_node,"bench"))
