import unittest
import benchmarks.bench_ring_map as bm

class TestBenchRingMap(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_map; self.assertTrue(hasattr(benchmarks.bench_ring_map,"bench"))
