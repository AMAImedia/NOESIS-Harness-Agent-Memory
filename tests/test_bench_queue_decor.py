import unittest
import benchmarks.bench_queue_decor as bm

class TestBenchQueueDecor(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_decor; self.assertTrue(hasattr(benchmarks.bench_queue_decor,"bench"))
