import unittest
import benchmarks.bench_queue_emit as bm

class TestBenchQueueEmit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_emit; self.assertTrue(hasattr(benchmarks.bench_queue_emit,"bench"))
