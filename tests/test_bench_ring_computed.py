import unittest
import benchmarks.bench_ring_computed as bm

class TestBenchRingComputed(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_computed; self.assertTrue(hasattr(benchmarks.bench_ring_computed,"bench"))
