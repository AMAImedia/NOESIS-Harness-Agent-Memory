import unittest
import benchmarks.bench_ring_end as bm

class TestBenchRingEnd(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_end; self.assertTrue(hasattr(benchmarks.bench_ring_end,"bench"))
