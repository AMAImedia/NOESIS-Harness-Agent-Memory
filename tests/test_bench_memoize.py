import unittest
import benchmarks.bench_memoize as bm

class TestBenchMemoize(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_memoize; self.assertTrue(hasattr(benchmarks.bench_memoize, "bench"))
