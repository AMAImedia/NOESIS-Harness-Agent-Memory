import unittest
import benchmarks.bench_ring_hold as bm

class TestBenchRingHold(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_hold; self.assertTrue(hasattr(benchmarks.bench_ring_hold,"bench"))
