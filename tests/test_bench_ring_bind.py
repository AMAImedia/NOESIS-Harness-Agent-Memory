import unittest
import benchmarks.bench_ring_bind as bm

class TestBenchRingBind(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_bind; self.assertTrue(hasattr(benchmarks.bench_ring_bind,"bench"))
