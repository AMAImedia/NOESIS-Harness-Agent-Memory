import unittest
import benchmarks.bench_queue_stop as bm

class TestBenchQueueStop(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_stop; self.assertTrue(hasattr(benchmarks.bench_queue_stop,"bench"))
