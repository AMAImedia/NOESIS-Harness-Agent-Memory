import unittest
import benchmarks.bench_ring_quit as bm

class TestBenchRingQuit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_quit; self.assertTrue(hasattr(benchmarks.bench_ring_quit,"bench"))
