import unittest
import benchmarks.bench_bitmask as bm

class TestBenchBitmask(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_bitmask; self.assertTrue(hasattr(benchmarks.bench_bitmask, "bench"))
