import unittest
import benchmarks.bench_queue_map as bm

class TestBenchQueueMap(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_map; self.assertTrue(hasattr(benchmarks.bench_queue_map,"bench"))
