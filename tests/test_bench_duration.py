import unittest
import benchmarks.bench_duration as bm

class TestBenchDuration(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_duration; self.assertTrue(hasattr(benchmarks.bench_duration, "bench"))
