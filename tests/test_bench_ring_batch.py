import unittest
import benchmarks.bench_ring_batch as bm

class TestBenchRingBatch(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_batch; self.assertTrue(hasattr(benchmarks.bench_ring_batch,"bench"))
