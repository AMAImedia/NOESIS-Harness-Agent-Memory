import unittest
import benchmarks.bench_template as bm
class TestBenchTemplate(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_template; self.assertTrue(hasattr(benchmarks.bench_template,"bench"))
