import unittest
import benchmarks.bench_retry_util as bm

class TestBenchRetry(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_retry_util; self.assertTrue(hasattr(benchmarks.bench_retry_util,"bench"))
