import unittest
import benchmarks.bench_ordered_set as bm

class TestBenchOS(unittest.TestCase):
    def test_main_zero(self): self.assertEqual(bm.main(["--items", "10"]), 0)
    ...
    def test_count(self): self.assertEqual(bm.bench(7)["items"], 7)
    def test_lazy(self): import benchmarks.bench_ordered_set; self.assertTrue(hasattr(benchmarks.bench_ordered_set, "bench"))
