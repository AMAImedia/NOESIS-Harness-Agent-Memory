import unittest
import benchmarks.bench_queue_facade as bm

class TestBenchQueueFacade(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_facade; self.assertTrue(hasattr(benchmarks.bench_queue_facade,"bench"))
