import unittest
import benchmarks.bench_chunked_write as bm

class TestBenchChunkedWrite(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_chunked_write; self.assertTrue(hasattr(benchmarks.bench_chunked_write,"bench"))
