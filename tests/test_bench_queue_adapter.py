import unittest
import benchmarks.bench_queue_adapter as bm

class TestBenchQueueAdapter(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_adapter; self.assertTrue(hasattr(benchmarks.bench_queue_adapter,"bench"))
