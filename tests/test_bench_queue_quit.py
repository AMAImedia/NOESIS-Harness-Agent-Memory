import unittest
import benchmarks.bench_queue_quit as bm

class TestBenchQueueQuit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_quit; self.assertTrue(hasattr(benchmarks.bench_queue_quit,"bench"))
