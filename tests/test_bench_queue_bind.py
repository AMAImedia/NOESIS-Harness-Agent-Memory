import unittest
import benchmarks.bench_queue_bind as bm

class TestBenchQueueBind(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_bind; self.assertTrue(hasattr(benchmarks.bench_queue_bind,"bench"))
