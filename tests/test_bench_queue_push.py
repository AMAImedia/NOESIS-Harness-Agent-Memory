import unittest
import benchmarks.bench_queue_push as bm

class TestBenchQueuePush(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_push; self.assertTrue(hasattr(benchmarks.bench_queue_push,"bench"))
