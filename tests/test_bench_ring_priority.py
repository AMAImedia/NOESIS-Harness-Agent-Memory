import unittest
import benchmarks.bench_ring_priority as bm

class TestBenchRingPriority(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_priority; self.assertTrue(hasattr(benchmarks.bench_ring_priority,"bench"))
