import unittest
import benchmarks.bench_queue_pull as bm

class TestBenchQueuePull(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_pull; self.assertTrue(hasattr(benchmarks.bench_queue_pull,"bench"))
