import unittest
import benchmarks.bench_queue_node as bm

class TestBenchQueueNode(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_node; self.assertTrue(hasattr(benchmarks.bench_queue_node,"bench"))
