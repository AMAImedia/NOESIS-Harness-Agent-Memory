import unittest
import benchmarks.bench_ring_flush as bm

class TestBenchRingFlush(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_flush; self.assertTrue(hasattr(benchmarks.bench_ring_flush,"bench"))
