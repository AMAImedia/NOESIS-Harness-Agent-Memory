import unittest
import benchmarks.bench_chunked_read as bm

class TestBenchChunkedRead(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_chunked_read; self.assertTrue(hasattr(benchmarks.bench_chunked_read,"bench"))
