import unittest
import benchmarks.bench_base24 as bm

class TestBenchBase24(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_base24; self.assertTrue(hasattr(benchmarks.bench_base24,"bench"))
