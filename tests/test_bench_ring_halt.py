import unittest
import benchmarks.bench_ring_halt as bm

class TestBenchRingHalt(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_halt; self.assertTrue(hasattr(benchmarks.bench_ring_halt,"bench"))
