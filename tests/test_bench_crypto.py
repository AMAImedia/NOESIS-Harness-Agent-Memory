import unittest
import benchmarks.bench_crypto as bm

class TestBenchCrypto(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_crypto; self.assertTrue(hasattr(benchmarks.bench_crypto,"bench"))
