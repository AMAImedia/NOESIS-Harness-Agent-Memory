import unittest
import benchmarks.bench_retry_simple as bm

class TestBenchRetrySimple(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_retry_simple; self.assertTrue(hasattr(benchmarks.bench_retry_simple,"bench"))
