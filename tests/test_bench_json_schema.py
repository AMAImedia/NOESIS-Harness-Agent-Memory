import unittest
import benchmarks.bench_json_schema as bm

class TestBenchJsonSchema(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_json_schema; self.assertTrue(hasattr(benchmarks.bench_json_schema,"bench"))
