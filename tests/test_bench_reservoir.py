import unittest
import benchmarks.bench_reservoir as bm

class TestBenchReservoir(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_reservoir; self.assertTrue(hasattr(benchmarks.bench_reservoir, "bench"))
