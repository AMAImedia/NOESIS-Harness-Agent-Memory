import unittest
import benchmarks.bench_validate_util as bm

class TestBenchValidateUtil(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_validate_util; self.assertTrue(hasattr(benchmarks.bench_validate_util,"bench"))
