import unittest
import benchmarks.bench_interval as bm

class TestBenchInterval(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_interval; self.assertTrue(hasattr(benchmarks.bench_interval, "bench"))
