import unittest
import benchmarks.bench_ring_push as bm

class TestBenchRingPush(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_push; self.assertTrue(hasattr(benchmarks.bench_ring_push,"bench"))
