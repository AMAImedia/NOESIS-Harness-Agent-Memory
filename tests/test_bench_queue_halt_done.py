import unittest
import benchmarks.bench_queue_halt_done as bm

class TestBenchQueueHaltDone(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_halt_done; self.assertTrue(hasattr(benchmarks.bench_queue_halt_done,"bench"))
