import unittest
import benchmarks.bench_queue_pipe as bm

class TestBenchQueuePipe(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_pipe; self.assertTrue(hasattr(benchmarks.bench_queue_pipe,"bench"))
