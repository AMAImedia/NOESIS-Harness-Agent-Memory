import unittest
import benchmarks.bench_queue_wait as bm

class TestBenchQueueWait(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_wait; self.assertTrue(hasattr(benchmarks.bench_queue_wait,"bench"))
