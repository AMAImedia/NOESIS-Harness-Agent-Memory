import unittest
import benchmarks.bench_queue_exit as bm

class TestBenchQueueExit(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_exit; self.assertTrue(hasattr(benchmarks.bench_queue_exit,"bench"))
