import unittest
import benchmarks.bench_lru as bm

class TestBenchLRU(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_lru; self.assertTrue(hasattr(benchmarks.bench_lru, "bench"))
