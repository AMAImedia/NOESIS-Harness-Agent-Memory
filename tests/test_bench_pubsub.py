import unittest
import benchmarks.bench_pubsub as bm

class TestBenchPubSub(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_pubsub; self.assertTrue(hasattr(benchmarks.bench_pubsub, "bench"))
