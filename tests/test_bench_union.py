import unittest
import benchmarks.bench_union as bm
class TestBenchUnion(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_union; self.assertTrue(hasattr(benchmarks.bench_union,"bench"))
