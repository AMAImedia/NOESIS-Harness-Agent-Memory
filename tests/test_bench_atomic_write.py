import unittest
import benchmarks.bench_atomic_write as bm

class TestBenchAtomicWrite(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_atomic_write; self.assertTrue(hasattr(benchmarks.bench_atomic_write, "bench"))
