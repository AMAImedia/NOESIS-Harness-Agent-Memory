import unittest
import benchmarks.bench_ring_decor as bm

class TestBenchRingDecor(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_decor; self.assertTrue(hasattr(benchmarks.bench_ring_decor,"bench"))
