import unittest
import benchmarks.bench_ring_facade as bm

class TestBenchRingFacade(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_facade; self.assertTrue(hasattr(benchmarks.bench_ring_facade,"bench"))
