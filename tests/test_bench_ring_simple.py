import unittest
import benchmarks.bench_ring_simple as bm

class TestBenchRingSimple(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_simple; self.assertTrue(hasattr(benchmarks.bench_ring_simple,"bench"))
