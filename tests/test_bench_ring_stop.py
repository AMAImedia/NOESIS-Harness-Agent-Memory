import unittest
import benchmarks.bench_ring_stop as bm

class TestBenchRingStop(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_stop; self.assertTrue(hasattr(benchmarks.bench_ring_stop,"bench"))
