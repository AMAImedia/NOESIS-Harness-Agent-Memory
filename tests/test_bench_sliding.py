import unittest
import benchmarks.bench_sliding as bm

class TestBenchSliding(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_sliding; self.assertTrue(hasattr(benchmarks.bench_sliding, "bench"))
