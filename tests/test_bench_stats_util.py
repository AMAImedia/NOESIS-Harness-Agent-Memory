import unittest
import benchmarks.bench_stats_util as bm

class TestBenchStatsUtil(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_stats_util; self.assertTrue(hasattr(benchmarks.bench_stats_util,"bench"))
