import unittest
import benchmarks.bench_progress_util as bm

class TestBenchProgressUtil(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_progress_util; self.assertTrue(hasattr(benchmarks.bench_progress_util,"bench"))
