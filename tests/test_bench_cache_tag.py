import unittest
import benchmarks.bench_cache_tag as bm

class TestBenchCacheTag(unittest.TestCase):
    ...
    def test_size(self): self.assertEqual(bm.bench(7)["size"], 7)
    def test_lazy(self): import benchmarks.bench_cache_tag; self.assertTrue(hasattr(benchmarks.bench_cache_tag, "bench"))
