import unittest
import benchmarks.bench_pipeline as bm

class TestBenchPipe(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_pipeline; self.assertTrue(hasattr(benchmarks.bench_pipeline, "bench"))
