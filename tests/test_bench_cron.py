import unittest
import benchmarks.bench_cron as bm

class TestBenchCron(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_cron; self.assertTrue(hasattr(benchmarks.bench_cron, "bench"))
