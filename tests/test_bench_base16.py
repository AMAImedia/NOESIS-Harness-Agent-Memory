import unittest
import benchmarks.bench_base16 as bm

class TestBenchBase16(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_base16; self.assertTrue(hasattr(benchmarks.bench_base16,"bench"))
