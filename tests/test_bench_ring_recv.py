import unittest
import benchmarks.bench_ring_recv as bm

class TestBenchRingRecv(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_recv; self.assertTrue(hasattr(benchmarks.bench_ring_recv,"bench"))
