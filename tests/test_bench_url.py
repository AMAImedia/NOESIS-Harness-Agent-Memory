import unittest
import benchmarks.bench_url as bm
class TestBenchUrl(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_url; self.assertTrue(hasattr(benchmarks.bench_url,"bench"))
