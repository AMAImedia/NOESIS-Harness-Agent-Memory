import unittest
import benchmarks.bench_topo as bm
class TestBenchTopo(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_topo; self.assertTrue(hasattr(benchmarks.bench_topo,"bench"))
