import unittest
import benchmarks.bench_queue_simple as bm

class TestBenchQueueSimple(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_simple; self.assertTrue(hasattr(benchmarks.bench_queue_simple,"bench"))
