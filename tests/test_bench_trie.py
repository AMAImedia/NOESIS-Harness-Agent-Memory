import unittest
import benchmarks.bench_trie as bm

class TestBenchTrie(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_trie; self.assertTrue(hasattr(benchmarks.bench_trie, "bench"))
