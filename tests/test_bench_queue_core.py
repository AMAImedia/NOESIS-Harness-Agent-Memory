import unittest
import benchmarks.bench_queue_core as bm

class TestBenchQueueCore(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_core; self.assertTrue(hasattr(benchmarks.bench_queue_core,"bench"))
