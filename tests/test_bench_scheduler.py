import unittest
import benchmarks.bench_scheduler as bm

class TestBenchScheduler(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_scheduler; self.assertTrue(hasattr(benchmarks.bench_scheduler, "bench"))
