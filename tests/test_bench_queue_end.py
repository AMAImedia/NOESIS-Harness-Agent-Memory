import unittest
import benchmarks.bench_queue_end as bm

class TestBenchQueueEnd(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_end; self.assertTrue(hasattr(benchmarks.bench_queue_end,"bench"))
