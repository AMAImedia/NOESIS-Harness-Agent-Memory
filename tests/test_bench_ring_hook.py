import unittest
import benchmarks.bench_ring_hook as bm

class TestBenchRingHook(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_hook; self.assertTrue(hasattr(benchmarks.bench_ring_hook,"bench"))
