import unittest
import benchmarks.bench_deque as bm

class TestBenchDeque(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_deque; self.assertTrue(hasattr(benchmarks.bench_deque, "bench"))
