import unittest
import benchmarks.bench_ring_dedup as bm

class TestBenchRingDedup(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_dedup; self.assertTrue(hasattr(benchmarks.bench_ring_dedup,"bench"))
