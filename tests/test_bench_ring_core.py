import unittest
import benchmarks.bench_ring_core as bm

class TestBenchRingCore(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_core; self.assertTrue(hasattr(benchmarks.bench_ring_core,"bench"))
