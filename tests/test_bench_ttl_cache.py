import unittest
import benchmarks.bench_ttl_cache as bm

class TestBenchTTL(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ttl_cache; self.assertTrue(hasattr(benchmarks.bench_ttl_cache, "bench"))
