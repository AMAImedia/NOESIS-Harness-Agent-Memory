import unittest
import benchmarks.bench_ring_sink as bm

class TestBenchRingSink(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_sink; self.assertTrue(hasattr(benchmarks.bench_ring_sink,"bench"))
