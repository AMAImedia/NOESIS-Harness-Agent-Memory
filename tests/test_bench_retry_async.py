import unittest
import benchmarks.bench_retry_async as bm

class TestBenchRetryAsync(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_retry_async; self.assertTrue(hasattr(benchmarks.bench_retry_async,"bench"))
