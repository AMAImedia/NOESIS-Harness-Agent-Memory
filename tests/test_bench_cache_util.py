import unittest
import benchmarks.bench_cache_util as bm

class TestBenchCacheUtil(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_cache_util; self.assertTrue(hasattr(benchmarks.bench_cache_util,"bench"))
