import unittest
import benchmarks.bench_ring_adapter as bm

class TestBenchRingAdapter(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_adapter; self.assertTrue(hasattr(benchmarks.bench_ring_adapter,"bench"))
