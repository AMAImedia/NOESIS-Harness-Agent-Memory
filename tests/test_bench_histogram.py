import unittest
import benchmarks.bench_histogram as bm

class TestBenchHist(unittest.TestCase):
    ...
    def test_total(self): self.assertEqual(bm.bench(7)["total"], 7)
    def test_lazy(self): import benchmarks.bench_histogram; self.assertTrue(hasattr(benchmarks.bench_histogram, "bench"))
