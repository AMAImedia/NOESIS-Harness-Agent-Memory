import unittest
import benchmarks.bench_queue_hold as bm

class TestBenchQueueHold(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_hold; self.assertTrue(hasattr(benchmarks.bench_queue_hold,"bench"))
