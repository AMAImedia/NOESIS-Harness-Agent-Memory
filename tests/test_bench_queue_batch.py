import unittest
import benchmarks.bench_queue_batch as bm

class TestBenchQueueBatch(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_batch; self.assertTrue(hasattr(benchmarks.bench_queue_batch,"bench"))
