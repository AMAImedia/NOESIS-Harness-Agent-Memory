import unittest
import benchmarks.bench_validate_chain as bm

class TestBenchValidateChain(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_validate_chain; self.assertTrue(hasattr(benchmarks.bench_validate_chain,"bench"))
