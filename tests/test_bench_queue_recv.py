import unittest
import benchmarks.bench_queue_recv as bm

class TestBenchQueueRecv(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_recv; self.assertTrue(hasattr(benchmarks.bench_queue_recv,"bench"))
