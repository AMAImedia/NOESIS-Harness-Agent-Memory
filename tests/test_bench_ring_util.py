import unittest
import benchmarks.bench_ring_util as bm

class TestBenchRing(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_util; self.assertTrue(hasattr(benchmarks.bench_ring_util,"bench"))
