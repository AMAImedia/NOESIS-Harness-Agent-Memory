import unittest
import benchmarks.bench_queue_computed as bm

class TestBenchQueueComputed(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_computed; self.assertTrue(hasattr(benchmarks.bench_queue_computed,"bench"))
