import unittest
import benchmarks.bench_ring_proxy as bm

class TestBenchRingProxy(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_ring_proxy; self.assertTrue(hasattr(benchmarks.bench_ring_proxy,"bench"))
