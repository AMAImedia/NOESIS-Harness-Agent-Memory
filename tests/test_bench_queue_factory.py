import unittest
import benchmarks.bench_queue_factory as bm

class TestBenchQueueFactory(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_factory; self.assertTrue(hasattr(benchmarks.bench_queue_factory,"bench"))
