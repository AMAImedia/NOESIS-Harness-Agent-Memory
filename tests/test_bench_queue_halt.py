import unittest
import benchmarks.bench_queue_halt as bm

class TestBenchQueueHalt(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_halt; self.assertTrue(hasattr(benchmarks.bench_queue_halt,"bench"))
