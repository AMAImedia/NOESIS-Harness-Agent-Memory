import unittest
import benchmarks.bench_tree as bm

class TestBenchTree(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_tree; self.assertTrue(hasattr(benchmarks.bench_tree, "bench"))
