import unittest
import benchmarks.bench_queue_hook as bm

class TestBenchQueueHook(unittest.TestCase):
    ...
    def test_lazy(self): import benchmarks.bench_queue_hook; self.assertTrue(hasattr(benchmarks.bench_queue_hook,"bench"))
